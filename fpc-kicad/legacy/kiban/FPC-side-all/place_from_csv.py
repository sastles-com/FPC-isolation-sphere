...
csv_path = "/Users/katano/isolation-sphere/kiban/FPC-side-all/side_layout.csv"
...
def set_footprint(ref_prefix="C", csv_path=csv_path):
    with open(csv_path, "r", newline="") as f:
        ...
        for row in reader:
            ...
            print(f"Placing {ref} at ({x}, {y}) with rotation {theta}°")
